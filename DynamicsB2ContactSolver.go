...
func MakeB2ContactSolver(_step B2TimeStep, _contacts []B2ContactInterface, _count int, _positions []B2Position, _velocities []B2Velocity) B2ContactSolver {
	solver := B2ContactSolver{}

	solver.M_step = _step
	solver.M_count = _count
	...
	solver.M_positions = _positions
	solver.M_velocities = _velocities
	solver.M_contacts = _contacts
